...
import com.alibaba.nacos.shaded.io.opencensus.trace.BlankSpan;
 ...
 * @BelongsPackage: cn.bugstack.aop
 * @Author: yueyueking
 * @CreateTime: 2024-12-01  17:00
 * @Description: TODO
 * @Version: 1.0
 */
...
public class RateLimiterAOP {
    ...
    // 这个切点表示要拦截哪些方法。
    // 切点表达式 @annotation(cn.bugstack.types.annotations.RateLimiterAccessInterceptor) 表示匹配所有带有 @RateLimiterAccessInterceptor 注解的方法。
